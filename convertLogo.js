...
try {
  if (fs.existsSync(pngPath)) {
    ...
    console.log(`Logo dimensions parsed: ${width}x${height}`);
  ...
  <image width="100%" height="100%" href="data:image/png;base64,${base64String}"/>
    ...
    console.log('✔ Successfully wrapped Logo.png into Logo.svg!');
    console.log('SVG Size: ' + (fs.statSync(svgPath).size / 1024).toFixed(2) + ' KB');
  } else {
    console.error('Error: Logo.png not found at ' + pngPath);
  }
} catch (err) {
